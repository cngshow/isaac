...
{
	private static Logger log = LogManager.getLogger(HL7RequestGenerator.class.getPackage().getName());

	/**
	 * The <code>getSiteDataRequestMessage</code> method returns a String representation
	 * of a MFQ_M01 message used to request Site Data from MFS.
	 * @param regionName
	 * @return String representation of site data request message
	 * @throws STSException
	 */
	public static String getSiteDataRequestMessage(String regionName) throws STSException
	{
		String sendingApplicationName = ApplicationPropertyReader
				.getApplicationProperty("msh.sendingApplication.namespaceId.siteData");
		String receivingApplicationName = ApplicationPropertyReader
				.getApplicationProperty("msh.receivingApplication.namespaceId.siteData");
	...
	/**
	 * The <code>getMappingSiteDataRequestMessage</code> method returns a String representation
	 * of a MFQ_M01 message used to request Mapping Site Data from MFS
	 * @param mapSetVuid
	 * @return String representation of mapping site data request message
	 * @throws STSException
	 */
	public static String getMappingSiteDataRequestMessage(Long mapSetVuid) throws STSException
	{
		String sendingApplicationName = ApplicationPropertyReader
				.getApplicationProperty("msh.sendingApplication.namespaceId.siteData");
		String receivingApplicationName = ApplicationPropertyReader
	...
	/**
	 * The <code>getChecksumRequestMessage</code> method returns a String representation
	 * of a MFQ_M01 message used to request a Checksum from MFS.
	 * @param regionName
	 * @return String representation of checksum request message
	 * @throws STSException
	 */
	public static String getChecksumRequestMessage(String regionName) throws STSException
	{
		String sendingApplicationName = ApplicationPropertyReader
				.getApplicationProperty("msh.sendingApplication.namespaceId.md5");
		String receivingApplicationName = ApplicationPropertyReader
				.getApplicationProperty("msh.receivingApplication.namespaceId.md5");
	...
	/**
	 * The <code>getMappingChecksumRequestMessage</code> method returns a String representation
	 * of a MFQ_M01 message used to request a Mapping Checksum from MFS.
	 * @param mapSetVuid
	 * @return String representation of mapping checksum request message
	 * @throws STSException
	 */
	public static String getMappingChecksumRequestMessage(Long mapSetVuid) throws STSException
	{
		String sendingApplicationName = ApplicationPropertyReader
				.getApplicationProperty("msh.sendingApplication.namespaceId.md5");
		String receivingApplicationName = ApplicationPropertyReader
	...
	private static MFQ_M01 getHL7RequestMessage(String sendingApplicationName, String receivingApplicationName,
			Long mapSetVuid, String regionName) throws STSException
	{
		...
		try
		{
			...
			if(regionName != null)
			{
				dataRequestMessage.addQrdSegment(dataRequestMessage, hl7DateString, regionName);
			}
			else
			{
				dataRequestMessage.addFilteredQrdSegment(dataRequestMessage, hl7DateString, MAPPINGS_IDENTIFIER, mapSetVuid.toString());
			}
		}
	...
	/**
	 * The <code>getMessage</code> method converts from a MFQ_M01 message
	 * object generated by the HAPI library to a String representation of the
	 * message that may be printed to the console, etc.
	 *
	 * @param message
	...
	/**
	 * The <code>getMessage</code> method converts from an HL7 message string
	 * to a MFN_M01 message object.
	 *
	 * @param messageString
	...
	{
		//		String filteredRequestMessage = HL7RequestGenerator.getSiteDataRequestMessage("SCT2ICD9");
		//		String unfilteredRequestMessage = HL7RequestGenerator.getSiteDataRequestMessage("Reactants");
		...
		//
		//		String filteredMD5RequestMessage = HL7RequestGenerator.getChecksumRequestMessage("SCT2ICD9");
		//		String unfilteredMD5RequestMessage = HL7RequestGenerator.getChecksumRequestMessage("Reactants");
