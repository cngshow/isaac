...
public class ChecksumParser extends BaseParser
{
	...
	/**
     * The msaMessage will be vista embedded string ;CHECKSUM:f8788e471664f6b285b4472660e2e3c9;VERSION:13;
     * The vista embedded string may or may not be present in the message.
     * 
     * @param msaMessage
     */
    ...
    /*
     * Search for the CHECKSUM substring to determine if the message
     * is a checksum response
     */
