...
import ca.uhn.hl7v2.model.v26.segment.Zxx;
...
public class VetsMfnM01Mfezxx extends MFN_M01_MF
{
	...
	public VetsMfnM01Mfezxx(Group parent, ModelClassFactory factory) {
		...
		try {
			...
			log.error("Unexpected error creating VetsMfnM01Mfezxx - this is probably a bug in the source code generator.", e);
		}
	}
	 ...
	 *
	 * @param mfeGroup MFE segment to shich ZRT segments will be added
	 * @param nameValueObject Data to be added in the ZRT segment, such as Properties or Relationships name/value pairs
	 * @param zrtCounter Ordinal ranking of this ZRT segment under the current MFE segment
	 * @throws HL7Exception
	 */
	public void addZrtSegment(VetsMfnM01Mfezxx mfeGroup, NameValueDTO nameValueObject, int zrtCounter) throws HL7Exception
	{
	 ...
	 * MFE.getPrimaryKeyValueMFE() in an MFE segment.  This method does not take the VUID
	 * as a parameter for concepts that do not have a VUID - specifically for
	 * the case of updating the standard terminology version file.
	 *
	 * @param subset Name of the subset for which the record is being created
	 * @param conceptName Name of the concept for which the record is being created
	 ...
	 *
	 * @param subset Name of the subset for which the record is being created
	 * @param conceptVuid VUID of the concept for which the record is being created
	 * @param conceptName Name of the concept for which the record is being created
	 * @return CE datatype object
	 * @throws DataTypeException
	 */
	public CE getCeObject(String subset, String conceptVuidString, Message message) throws DataTypeException
	{
		...
		//g1R.MFE.4.1 - This is two pieces: File Flag '@' VUID
		subFieldSeparator = ApplicationPropertyReader.getApplicationProperty("ce.subFieldSeparator");
