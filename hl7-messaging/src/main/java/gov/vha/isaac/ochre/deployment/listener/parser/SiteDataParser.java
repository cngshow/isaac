...
//                    if (params.length < 10)
//                    {
//                        throw new Exception("MSH_SEGMENT paramter count ="+params.length+" need to have greater than 9");
//                    }
//                    siteValue = params[3];
//                    messageId = params[9];
...
//                {
//                    // check to see if we didn't get the status line and are dumping values
//                    if (saveList.size() > 0)
//                    {
...
//                        saveList.clear();
//                    }
//                    if (params.length >= 5) // make sure we have the right number of parameters
//                    {
...
//                                if (first)
//                                {
//                                    log.debug("Creating entry in siteDataRequest for " + site.getId() + "  subset: " + regionName);
...
//                {
//                    if (params.length >= 3)  // make sure we have the right number of parameters
//                    {
...
//                            {
//                            	MapSet mapSet = MapSetDelegate.getByVuid(Long.valueOf(value), HibernateSessionFactory.AUTHORING_VERSION_ID);
//                                regionName = mapSet.getName();
//                                if (first)
//                                {
//                                    log.debug("Creating entry in siteDataRequest for " + site.getId() + "  mapping: " + regionName);
//                                    ListenerDelegate.createSiteDataRequest(site.getId(), regionName);
//                                    first = false;
//                                }
//                            }
...
//                        	{
//                        		log.warn("Incoming site data value over 2000 characters. Data value truncated in database. " +
//                        					"Full data value: " + value);
//                        		value = "TRUNCATED: " + value.substring(0, 1989);
//                        	}
//                        	
//                            SiteDataDTO siteDataDTO = new SiteDataDTO(typeName, value, Long.parseLong(vuid.trim()), site, regionName, type);
//                            if (hasStatus)
//                            {
//                            	siteDataDTO.setActive(status);
//                            	siteDataDTOs.add(siteDataDTO);
...
//            //ListenerDelegate.createSiteData(site.getId(), regionName, siteDataDTOs);
//            
//            log.info("SITE DATA MESSAGE RECEIVED" + "; SITE NAME: " + site.getName() + "; SITE ID: " + site.getVaSiteId()  //getTopic()
//                    + "; MSG. ID: " + messageId);
//        }
//        catch (Exception e)
//        {
...
//    }
    ...
    public static final void main(String[] args) throws Exception
    {
        ...
        + "MFE^MUP^^^Mappings@210\r"
        + "ZRT^MapDefinition^1884397\r"
        + "ZRT^SourceCode^2972007\r"
        + "ZRT^TargetCode^433.80\r"
        + "ZRT^Order^1\r"
        + "ZRT^EffectiveDate^20060131\r"
        + "ZRT^Active^1\r"
        + "MFE^MUP^^^Mappings@211\r"
        + "ZRT^MapDefinition^1884397\r"
        + "ZRT^SourceCode^2973002\r"
        + "ZRT^TargetCode^867.8v\r"
        + "ZRT^Order^1\r"
        + "ZRT^EffectiveDate^20060131\r"
        + "ZRT^Active^1\r"
        + "MFE^MUP^^^Mappings@212\r"
        + "ZRT^MapDefinition^1884397\r"
        + "ZRT^SourceCode^2992000\r"
        + "ZRT^TargetCode^333.0\r"
        + "ZRT^Order^1\r"
        + "ZRT^EffectiveDate^20060131\r"
        + "ZRT^Active^1\r";        
        ...
        String content2 = 
         "MSH^~|&^VETS UPDATE^660DEV2^XUMF UPDATE^^20080509095700.000-0600^^MFN~M01^^^2.4^^^AL^AL^USA\r"
