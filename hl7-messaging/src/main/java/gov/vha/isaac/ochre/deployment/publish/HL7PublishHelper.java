...
public class HL7PublishHelper
{
	...
	public static String getResponseMessage(String messageHeader) throws Exception
	{
		...
		try
		{
			...
			String testSendingApplicationUniversalIDType = (msh != null) ? msh.getSendingApplication().getUniversalIDType().toString() : null;
			...
			String testReceivingAppUniversalIdType = (msh != null) ? msh.getReceivingApplication().getUniversalIDType().toString() : null;
			...
			//TODO: verify if the ling below will get the same as the line above
