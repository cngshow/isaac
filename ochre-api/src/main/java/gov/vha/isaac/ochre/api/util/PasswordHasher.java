...
public class PasswordHasher
{
	 ...
	 * Computes a salted PBKDF2 hash of given plaintext password with the provided salt
	 * Empty passwords are not supported.
	 * @return The returned hash will be URL safe per RFC 3986
	 */
	 ...
	 * @throws Exception
	 */
	public static String encrypt(String password, byte[] salt, byte[] data) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static byte[] decrypt(String password, byte[] salt, String data) throws Exception
	{
		SecretKeyFactory keyFactory = SecretKeyFactory.getInstance(keyFactoryAlgorithm);
		SecretKey key = keyFactory.generateSecret(new PBEKeySpec(password.toCharArray(), salt, iterations, desiredKeyLen));
		Cipher pbeCipher = Cipher.getInstance(cipherAlgorithm);
